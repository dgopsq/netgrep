...
| Test TS | `pnpm test` | Vitest — **195 tests**: 60 unit in Node, 64 integration in headless Chromium, 71 tooling in Node |
...
| Test Rust | `pnpm test:rust` | `cargo test`, native, no browser — **55 tests** |
